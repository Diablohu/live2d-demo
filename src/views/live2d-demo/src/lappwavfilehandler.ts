...
export let s_instance: LAppWavFileHandler | null | undefined = null;
...
export class LAppWavFileHandler {
                ...
                try {
                    ...
                    for (
                        ...
                        for (
                            ...
                            this._pcmData[channelCount][sampleCount] =
                                this.getPcmSample();
                        }
                    }
    ...
    _pcmData: Array<Float32Array> | null | undefined;
